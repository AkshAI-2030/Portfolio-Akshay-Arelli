...
const skills = [
  {
    ...
    technologies: [
      {
        name: "Bootstrap",
        icon: <DiBootstrap className="text-blue-600" />,
      },
      {
        name: "JavaScript",
      ...
      {
        name: "Html",
        icon: <DiHtml5 className="text-blue-600" />,
      },
      {
        name: "Css",
        icon: <DiCss3 className="text-yellow-500" />,
      },
    ...
    >
      <Reveal>
        ...
        <p className="text-center mb-8">
          As a passionate backend developer, I am constantly learning and
          building dynamic, scalable solutions.Please Explore my{" "}
          <Link
            to="portfolio"
            smooth={true}
            offset={-50}
